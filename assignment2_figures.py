...
ax.set_title("Kriminalitetens tyngdepunkter i San Francisco", fontsize=13, fontweight="bold")
ax.set_xlabel("Længdegrad")
...
<div style="position:fixed;top:12px;left:50%;transform:translateX(-50%);
  ...
  Heatmap — skift lag med kontrollen øverst til højre
</div>"""))
...
fig3 = go.Figure(go.Heatmap(
    ...
    colorbar=dict(title="Ratio<br>(1 = bygennemsnit)")
))
fig3.update_layout(
    title="Hvilke forbrydelser er over-/underrepræsenteret per politidistrikt?",
